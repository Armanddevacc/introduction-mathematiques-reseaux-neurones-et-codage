...
if __name__ == '__main__':
    ...
    Matrice_des_neurones = reseau.predire(picture, biais, poids, nombre_neurone, Matrice_des_neurones)
    for i in range(1,len(picture),10):
        Matrice_des_neurones = reseau.predire(picture[i:i+100], biais, poids, nombre_neurone, Matrice_des_neurones)
        print(cout.fonction_cout(picture[i:i+100], biais, poids,nombre_neurone, label,Matrice_des_neurones))

        for _ in range(10):
            biais,poids = reseau.calcul_nouveau_gradient(poids,biais,Matrice_des_neurones,label)
